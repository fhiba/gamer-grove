...
--- Sprint 5
ALTER TABLE modders ADD COLUMN IF NOT EXISTS since_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL;

---- Sprint 5

ALTER TABLE community ADD COLUMN IF NOT EXISTS total_rating FLOAT NOT NULL DEFAULT 0.0;
ALTER TABLE community ADD COLUMN IF NOT EXISTS rating_count INT NOT NULL DEFAULT 0;
