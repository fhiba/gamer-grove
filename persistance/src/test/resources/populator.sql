...
INSERT INTO post(title, body, author_id, community_name, media, media_id, post_date,category) VALUES ('First post', 'This is my first post', 1, 'test', false, null, '2020-01-01 00:00:00','Discussion');
-- id 1 is test
-- id 2 is other
-- id 3 is test2
