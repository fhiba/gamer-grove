...
import { fetchCommunities, fetchModeratos } from "../api";
...
const ModeratorManagement = () => {
  ...
  useEffect(() => {
    if (authToken) {
      setDecoded(decodeToken(authToken));
    }
  }, [authToken]);
