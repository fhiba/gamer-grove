                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs mb-3">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link active" href="${followedCommunitiesUrl}"><spring:message
                                    code="Profile.FollowedCommunities"/></a>
                        </li>
                    </ul>
                    <div class="d-flex row">
                        <div hidden="hidden">
                            <c:url value="/profile/followed" var="followedCommunitiesUrl"/>
                            ...
                            <c:if test="${empty followedCommunities.data}">
                                ...
                                <c:choose>
                                    <c:when test="${communities.size() > 0}">
                                        <div class="mt-5 d-flex justify-content-center">
                                            <div class="mb-4 d-flex flex-column align-items-center">
                                                ...
                                                <form action="${communitiesUrl}" method="get" onsubmit="searchCategories()" id="searchWithCategoriesForm">
                                                    <button class="btn btn-primary" type="submit"><spring:message code="Profile.findCommunities"/></button>
                                                </form>
                                            </div>
                                        </div>
                                    </c:when>
                                    <c:otherwise>
                                        <div class="mt-5 d-flex justify-content-center">
                                            <div class="mb-4 d-flex flex-column align-items-center">
                                                <h4><spring:message code="Profile.NoFollowedCommunities"/></h4>
                                                <a href="${communitiesUrl}" class="btn btn-primary w-50"><spring:message code="Profile.findCommunities"/></a>
                                            </div>
                                        </div>
                                    </c:otherwise>
                                </c:choose>
