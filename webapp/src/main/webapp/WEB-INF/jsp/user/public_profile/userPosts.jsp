                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs mb-3">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="${likedPostsUrl}"><spring:message code="PublicProfile.LikedPost"/></a>
                        </li>
                        <li class="nav-item">
                            <c:url var="followedCommunitiesUrl" value="/user/${user.id}/followed"/>
                    ...
                    <c:if test="${empty posts.data}">
                        <div class="mt-5 d-flex justify-content-center">
                            <div class="mb-4 d-flex flex-column align-items-center">
                                <h4><spring:message code="PublicProfile.NoUserPosts"/></h4>
