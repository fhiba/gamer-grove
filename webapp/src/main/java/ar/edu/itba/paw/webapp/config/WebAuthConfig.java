    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.sessionManagement()
            ...
            .and().authorizeRequests()
                ...
                .antMatchers("/community/{communityName}/new","/community/{communityName}/follow", "/post","/community/{communityName}/rate").hasRole("USER")
                .antMatchers(HttpMethod.POST,"/post/{postId}/+").hasRole("USER")
                .antMatchers(HttpMethod.POST,"/post/{postId}/up").hasRole("USER")
                .antMatchers(HttpMethod.POST,"/post").hasRole("USER")
                .antMatchers(HttpMethod.POST,"/comment").hasRole("USER")
                .antMatchers(HttpMethod.POST,"/community/{communityName}").hasRole("USER")
                .antMatchers(HttpMethod.POST,"/community/{communityName}/deleteRating").hasRole("USER")
