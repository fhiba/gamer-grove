...
public class CommunityController {
    ...
    public Response listCommunities(@Context UriInfo uriInfo, @QueryParam("page") @DefaultValue("1") final int page)
        ...
        return Response.ok(new GenericEntity<>(communityDTOs) {
                ...
                .link(uriInfo.getAbsolutePathBuilder().queryParam("page", communities.getPreviousPage()).build(), "prev")
    ...
    @GET
    @Path("/{communityName}")
    public Response getCommunity(@PathParam("communityName") final String communityName) throws NoSuchCommunityException {
...
//        mav.addObject("categories", Arrays.stream(CommunityCategories.values()).map(CommunityCategories::getCategory)
//                .toArray(String[]::new));
//        return mav;
//    }
//
...
//            @Valid @ModelAttribute("newCommunityForm") final NewCommunityForm newCommunityForm, BindingResult errors)
//            throws NoSuchCommunityException {
//        if (errors.hasErrors())
//            return newCommunity(newCommunityForm);
//        Optional<Community> newCom = cs.createCommunity(newCommunityForm.getName(), newCommunityForm.getDescription(),
//                newCommunityForm.getCategories(), newCommunityForm.getDeveloper(), newCommunityForm.getPublisher(),
...
//    public ModelAndView community(@RequestParam(required = false) Integer pageNumber,
...
//    public ModelAndView createPostOnCommunity(@PathVariable("communityName") final String communityName,
//            @ModelAttribute("newRatingForm") final NewRatingForm newRatingForm,
//            @ModelAttribute("followCommunityForm") final FollowCommunityForm followCommunityForm,
//            @Valid @ModelAttribute("newPostForm") final NewPostForm newPostForm, BindingResult errors)
...
//
//        Post post = ps.createPost(newPostForm.getTitle(), newPostForm.getBody(), communityName,
...
//    public ModelAndView communities(@RequestParam(required = false) Integer pageNumber,
...
//    public ModelAndView newCommunityPost(@PathVariable("communityName") final String communityName,
//            @ModelAttribute("newRatingForm") final NewRatingForm newRatingForm,
//            @ModelAttribute("followCommunityForm") final FollowCommunityForm followCommunityForm,
//            @Valid @ModelAttribute("newPostForm") final NewPostForm newPostForm, BindingResult errors)
//            throws NoSuchCommunityException, NoLoggedUserException {
...
//        Community community = cs.findByName(communityName);
//        Post post = ps.createPost(newPostForm.getTitle(), newPostForm.getBody(), community.getName(),
//                newPostForm.getCategory(), newPostForm.getFiles());
//        return new ModelAndView("redirect:/post/" + post.getId());
//    }
//
//    @RequestMapping(path = "/community/{communityName}/info", method = RequestMethod.GET)
//    public ModelAndView communityImage(@PathVariable("communityName") final String communityName,
//            @ModelAttribute("EditCommunityForm") final EditCommunityInfoForm editCommunityInfoForm)
//            throws NoSuchCommunityException {
...
//    public ModelAndView uploadCommunityImage(@PathVariable("communityName") final String communityName,
//            @Valid @ModelAttribute("EditCommunityForm") final EditCommunityInfoForm editCommunityInfoForm,
...
//    public ModelAndView followCommunity(@PathVariable("communityName") final String communityName,
//            @ModelAttribute("newRatingForm") final NewRatingForm newRatingForm,
//            @Valid @ModelAttribute("followCommunityForm") final FollowCommunityForm followCommunityForm,
...
//    public ModelAndView rateCommunity(@PathVariable("communityName") final String communityName,
//            @ModelAttribute("newPostForm") final NewPostForm newPostForm,
//            @ModelAttribute("followCommunityForm") final FollowCommunityForm followCommunityForm,
//            @Valid @ModelAttribute("newRatingForm") final NewRatingForm newRatingForm, BindingResult errors)
//            throws NoSuchCommunityException, NoLoggedUserException {
//        if (errors.hasErrors())
//            return community(null, communityName, newPostForm, followCommunityForm, newRatingForm);
...
//    public ModelAndView deleteRating(@PathVariable("communityName") final String communityName,
//            @ModelAttribute("newPostForm") final NewPostForm newPostForm,
//            @ModelAttribute("followCommunityForm") final FollowCommunityForm followCommunityForm,
//            @Valid @ModelAttribute("newRatingForm") final NewRatingForm newRatingForm, final BindingResult errors)
//            throws NoSuchCommunityException, NoLoggedUserException {
//        if (errors.hasErrors())
//            return community(null, communityName, newPostForm, followCommunityForm, newRatingForm);
